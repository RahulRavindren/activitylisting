...
object PreferenceManager {
    ...
    fun savePreferenceIfChanged(savedPreference: SavedPreference, value: Any?): Boolean {
        ...
        if (value is String) {
            ...
            val savedPref = getPreference(savedPreference, -1)!!
            ...
            val savedPref = getPreference(savedPreference, -1L) as Long
            ...
            val savedPref = getPreference(savedPreference, false)
            if (savedPref !== value) {
                savePreference(
                    savedPreference.getPreferenceType(),
                    savedPreference.getName(),
    ...
    fun getStringSet(key: String, defaultValue: Set<String>): Set<String> {
        return getPreference<Set<String>>(null, key, defaultValue)
    }
